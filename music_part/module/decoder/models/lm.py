...
# from ..quantization.core_vq import VectorQuantization
...
class LMModel(StreamingModule):
    ...
    def __init__(self, pattern_provider: CodebooksPatternProvider, condition_provider: ConditioningProvider,
        ...
        # self.vq = VectorQuantization(dim=dim, codebook_size=64, channels_last=True)
        ...
        self.linears_extra = nn.ModuleList([nn.Linear(self.card, 64, bias=bias_proj) for _ in range(n_q)])
    ...
    def forward(self, sequence: torch.Tensor,
        ...
        # cross_attention_input, _, vq_loss = self.vq(cross_attention_input)
        # vq_loss = 0
        ...
        # if self.training:
        #     return logits, vq_loss  # [B, K, S, card]
        # else:
        return logits
